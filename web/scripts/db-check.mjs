...
const REQUIRED_COLUMNS = {
  ...
  commuter_passes: ["pickup_lat", "pickup_lng", "dropoff_lat", "dropoff_lng", "agreed_fare", "driver_payout", "status"],
  institution_members: ["pickup_lat", "pickup_lng", "guardian_phone", "sms_opted_out"],
