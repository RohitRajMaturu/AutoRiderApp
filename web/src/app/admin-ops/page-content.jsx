...
function GhostDriverBadge() {
  return (
    <span
      ...
      style={{ background: "var(--ar-warn-dim)", color: GOLD }}
    >
      GHOST
    </span>
  );
    ...
    <Card ref={sectionRef}>
      ...
      {(snapshot.zoneActivity || []).length === 0 ? (
        <p className="text-sm font-bold" style={{ color: TEXT_SEC }}>
          ...
          <a className="font-semibold underline" style={{ color: PRIMARY }} href="/admin-ops">
            ...
            return (
              <div key={zone.zone_name}>
                <div className="mb-2 flex items-center gap-3 text-sm">
                  <span className="min-w-0 flex-1 truncate font-semibold" style={{ color: TEXT }}>
                    {zone.zone_name}
                  </span>
                  <span
                  ...
                  {zone.zone_id ? (
                    <button
                      ...
                      style={{
                        background: dispatchEnabled ? "var(--ar-accent-dim)" : SURFACE_2,
                        borderColor: dispatchEnabled ? PRIMARY : BORDER,
                      }}
                    ...
                    >
                      <span
                        ...
                        style={{
                          background: dispatchEnabled ? PRIMARY : TEXT_SEC,
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <h3 className="truncate text-sm font-semibold" style={{ color: TEXT }}>
              ...
              <dl className="mt-4 grid grid-cols-2 gap-3 text-xs">
                <div>
                  ...
                  <dd className="mt-1 font-semibold" style={{ color: TEXT }}>{driver.zone_name || "Unzoned"}</dd>
                </div>
                <div>
                  <dt className="font-bold" style={{ color: TEXT_SEC }}>Today</dt>
                  <dd className="mt-1 font-semibold" style={{ color: TEXT }}>{driver.today_trips} trips</dd>
                </div>
                <div>
                  <dt className="font-bold" style={{ color: TEXT_SEC }}>30 days</dt>
                  <dd className="mt-1 font-semibold" style={{ color: TEXT }}>{driver.completed_30d} trips</dd>
                </div>
                <div>
                  <dt className="font-bold" style={{ color: TEXT_SEC }}>Last active</dt>
                  <dd className="mt-1 font-semibold" style={{ color: TEXT }}>
                    {driver.on_trip ? "On trip now" : relativeTime(driver.last_ride_at)}
                  </dd>
                </div>
              </dl>
    ...
    <Card ref={sectionRef}>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-sm">
          <thead>
            <tr className="text-left text-xs font-semibold uppercase tracking-wide" style={{ color: TEXT_SEC }}>
          ...
          <tbody>
            {(snapshot.recentAuditLog || []).map((item) => (
              <tr key={item.id}>
                ...
                <td className="border-b px-3 py-3 font-semibold" style={{ borderColor: BORDER, color: TEXT }}>
          ...
          {data.map((item, index) => (
            <div key={item.reason}>
              <div className="mb-2 flex items-center justify-between gap-3 text-sm">
                ...
                <span className="rounded-full bg-red-50 px-2 py-1 text-xs font-semibold" style={{ color: ERROR }}>
                  {item.count}
                </span>
              </div>
              <div className="h-2 overflow-hidden rounded-full bg-slate-100">
